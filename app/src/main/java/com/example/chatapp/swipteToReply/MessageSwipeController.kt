package com.example.chatapp.swipteToReply
    ...
    class MessageSwipeController(
        ...
        private fun setTouchListener(
            ...
            recyclerView.setOnTouchListener { _, event ->
                ...
                if (swipeBack) {
                    if (Math.abs(mView.translationX) >= this@MessageSwipeController.convertTodp(50)) {
        ...
        private fun convertTodp(pixel: Int): Int {
            return AndroidUtil.dp(pixel.toFloat(), context)
        }
